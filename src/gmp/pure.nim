...
proc mpn_gcdext*(a2: var mp_limb_t; a3: var mp_limb_t; a4: ptr mp_size_t;
    ...
    dynlib: libgmp, cdecl.}
proc mpn_get_str*(a2: ptr char; a3: cint; a4: mp_ptr; a5: mp_size_t): csize_t {.
    importc: "__gmpn_get_str", dynlib: libgmp, cdecl.}
proc mpn_get_str*(a2: ptr char; a3: cint; a4: var mp_limb_t; a5: mp_size_t): csize_t {.
    importc: "__gmpn_get_str", dynlib: libgmp, cdecl.}
...
proc mpn_scan1*(a2: var mp_limb_t; a3: mp_bitcnt_t): mp_bitcnt_t {.
    importc: "__gmpn_scan1", dynlib: libgmp, cdecl.}
proc mpn_set_str*(a2: mp_ptr; a3: ptr char; a4: csize_t; a5: cint): mp_size_t {.
    importc: "__gmpn_set_str", dynlib: libgmp, cdecl.}
proc mpn_set_str*(a2: var mp_limb_t; a3: ptr char; a4: csize_t; a5: cint): mp_size_t {.
    importc: "__gmpn_set_str", dynlib: libgmp, cdecl.}
